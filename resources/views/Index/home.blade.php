...
{{--    Section belongs to emailId, Phone Number, And Social Icons--}}
...
{{--Section Third Offer Image--}}

    <section>
        <div class="row offerImage">
            <div class="col-md-4">
                <img src="{{ asset('/Images/OfferOne.png') }}" alt="Offer One">
            </div>
            <div class="col-md-4">
                <img src="{{ asset('/Images/OfferTwo.png') }}" alt="Offer Two">
            </div>
            <div class="col-md-4">
                <img src="{{ asset('/Images/OfferThree.png') }}" alt="Offer Three">
            </div>
        </div>
    </section>
